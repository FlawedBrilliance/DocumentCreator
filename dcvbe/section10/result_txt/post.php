<?php
	...
	if($_POST['token'])
	{
		...
		$sql22 = "DELETE FROM section10_testplan_resultstext
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql22);
	    ...
	    while($ctr>0)
	    {
	    	if(isset($_POST['ISCV_IBE_Parsing'.$ctr.'1']))
	    	{
				...
				$oru_expected_val = $_POST['Expected_Result'];

				$oru_actual_val = $_POST['Actual_Result'];
				...
				$oru_amended_expected_val = $_POST['Expected_Result1'];

				$oru_amended_actual_val = $_POST['Actual_Result1'];
				...
				$oru_amended2_expected_val = $_POST['Expected_Result2'];

				$oru_amended2_actual_val = $_POST['Actual_Result2'];

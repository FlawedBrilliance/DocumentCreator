<?php
	...
	if($_POST['token'])
	{
		...
		$sql = "DELETE FROM section9_ibeadt
	    ...
	    while($ctr>0)
	    {
	    	if(isset($_POST['pureId'.$ctr]))
	    	{
	    		...
	    		$orderName = $_POST['orderName'.$ctr];
	    		$orderCode = $_POST['orderCode'.$ctr];

	    		$sql = "INSERT INTO section9_ibeadt (sec_sign,pureId,orderName,orderCode)
	    				VALUES ('$token','$pureId','$orderName','$orderCode'); " ;
	    		mysqli_query($dcConn,$sql);
	    	}
	    	$ctr--;
	    }

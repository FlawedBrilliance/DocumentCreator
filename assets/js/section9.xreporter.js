...
$("#addRow").click(function()
{
	rowString = `
		    		<tr>
						<td>
							<div class="ui form">
								<input type="text" class="editField" id="options`+$tableCtr+`" name="options`+$tableCtr+`" readOnly />
							</div>
						</td>
						<td>
							<div class="ui form">
								<input type="text" class="editField" id="value`+$tableCtr+`" name="value`+$tableCtr+`" readOnly />
							</div>
						</td>
						<td>
							<div class="ui form">
...
//Data Fetch
var url = apiUrl+'/section9/xreporter/fetch.php?prs=' + prs + '&token=' + token ;
	...
	$.each(response.details,function(key,detail)
	{
		rowString = `
			    		<tr>
							<td>
								<div class="ui form">
									<input type="text" class="editField" value="`+detail.options+`" id="options`+$tableCtr+`" name="options`+$tableCtr+`" readOnly />
								</div>
							</td>
							<td>
								<div class="ui form">
									<input type="text" class="editField" value="`+detail.value+`" id="value`+$tableCtr+`" name="value`+$tableCtr+`" readOnly />
								</div>
							</td>
							<td>
								<div class="ui form">

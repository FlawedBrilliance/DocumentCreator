	...
	rowString = `
			<table class="ui celled table black unstackable" ">
						...
						<tbody>
							...
							<td>
								<div class="ui form">
									<input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`62" name="ISCV_IBE_Parsing`+$TableCtr+`62" />
								</div>
							</td>
							<td>
								<div class="ui form">
							...
							<td>
								<div class="ui form">
									<input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`63" name="ISCV_IBE_Parsing`+$TableCtr+`63" placeholder="TX" />
								</div>
							...
							<td>
								<div class="ui form">
									<input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`64" name="ISCV_IBE_Parsing`+$TableCtr+`64" placeholder="ISCV Study ID" />
								</div>
							...
							<td>
								<div class="ui form">
									<input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`6" name="ISCV_IBE_Parsing`+$TableCtr+`67" placeholder="P | F | C | R | D" />
								</div>
							</td>
							<td>
								<div class="ui form">
							...
							<td>
								<div class="ui form">
									<input type="text" id="Expected_HL7_Parsing`+$TableCtr+`71" name="Expected_HL7_Parsing`+$TableCtr+`71" />
								</div>
							</td>
							<td>
								<div class="ui form">
							...
							<td colspan="2">
								<div class="ui form">
									<input type="text" id="Actual_Value`+$TableCtr+`71" name="Actual_Value`+$TableCtr+`71" />
								</div>
							</td>
							<td>
							<div class="ui form">
								<input type="text" id="Pass_fail`+$TableCtr+`74" name="Pass_fail`+$TableCtr+`74" />
							</div>
							</td>
							<td>
							<div class="ui form">
								<input type="text" id="Comments`+$TableCtr+`74" name="Comments`+$TableCtr+`74" />
							</div>
							</td>
							<td>
							<div class="ui form">
								<input type="text" id="Sign_off`+$TableCtr+`74" name="Sign_off`+$TableCtr+`74" />
							</div>
							</td>
							</tr>

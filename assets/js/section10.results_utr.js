  ...
  rowString = `
      <table class="ui celled table black unstackable" ">
            ...
            <tbody>
                  ...
                  <td>
                    <div class="ui form">
                      <input type="text" id="Actual_Result" name="Actual_Result" />
                    </div>
                  </td>
                <td>
                  <div class="ui form">
              ...
              Verify version 2.
                ...
                <td>
                  <div class="ui form">
                    <input type="text" id="Expected_Result1" name="Expected_Result1"/>
                  </div>
                </td>
                <td>
                  <div class="ui form">
                    <input type="text" id="Actual_Result1" name="Actual_Result1" />
                  </div>
                </td>
                <td>
                <div class="ui form">
              ...
              Verify version 3.
                ...
                <td>
                  <div class="ui form">
                    <input type="text" id="Expected_Result2" name="Expected_Result2" />
                  </div>
                </td>
                <td>
                  <div class="ui form">
                    <input type="text" id="Actual_Result2" name="Actual_Result2"/>
                  </div>
                </td>
              <td>
                <div class="ui form">
...
$.getJSON(url,function(response)
{
        ...
        $.each(response.testplan_resultutr,function(key,resultpdf)
        {
                rowString = `
                <table class="ui celled table black unstackable" ">
            ...
            <tbody>
              ...
              Verify version 2.
                ...
                <td>
                  <div class="ui form">
                    <input type="text" id="Expected_Result1" name="Expected_Result1" value="`+resultpdf.oru_amended_expected_val+`"/>
                  </div>
                </td>
                <td>
                  <div class="ui form">
                    <input type="text" id="Actual_Result1" name="Actual_Result1" value="`+resultpdf.oru_amended_actual_val+`"/>
                  </div>
                </td>
                <td>
                <div class="ui form">
              ...
              Verify version 3.
                ...
                <td>
                  <div class="ui form">
                    <input type="text" id="Expected_Result2" name="Expected_Result2"  value="`+resultpdf.oru_amended2_expected_val+`"/>
                  </div>
                </td>
                <td>
                  <div class="ui form">
                    <input type="text" id="Actual_Result2" name="Actual_Result2"  value="`+resultpdf.oru_amended2_actual_val+`"/>
                  </div>
                </td>
              <td>
                <div class="ui form">
              ...
              <td>
                ...
                $('#results_utrTable tbody:last').before(rowString);
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_msh,function(key,resultpdfmsh)
        {
                rowString1 = `
<table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <div class="ui form">
                ...
                $('#results_utrTable tbody:last').before(rowString1);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_pid,function(key,resultpdfpid)
        {
                rowString2 = `
                <table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`14" name="Expected_HL7_Parsing`+$TableCtr+`14" value="`+resultpdfpid.pid_3_iscv_val+`"/>
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_Value`+$TableCtr+`14" name="Expected_Value`+$TableCtr+`14" value="`+resultpdfpid.pid_3_iscv_val+`"/>
                </div>
              </td>
              <td colspan="2">
                <div class="ui form">
                  <input type="text" id="Actual_Value`+$TableCtr+`14" name="Actual_Value`+$TableCtr+`14" value="`+resultpdfpid.pid_3_iscv_val+`"/>
                </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Pass_fail`+$TableCtr+`17" name="Pass_fail`+$TableCtr+`17" value="`+resultpdfpid.pid_3_iscv_val+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`17" name="Comments`+$TableCtr+`17" value="`+resultpdfpid.pid_3_iscv_val+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`17" name="Sign_off`+$TableCtr+`17" value="`+resultpdfpid.pid_3_iscv_val+`"/>
              </div>
              </td>
              </tr>
                      <tr>
              ...
              <div class="ui form">
                ...
                $('#results_utrTable tbody:last').before(rowString2);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_pv1,function(key,resultpdfpv1)
        {
                rowString3 = `
                <table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <div class="ui form">
                ...
                $('#results_utrTable tbody:last').before(rowString3);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_orc,function(key,resultpdforc)
        {
                rowString4 = `
<table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`43" name="Sign_off`+$TableCtr+`43" value="`+resultpdforc.orc_5_signoff+`" />
              </div>
              </td>
              </tr>
                ...
                $('#results_utrTable tbody:last').before(rowString4);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_obr,function(key,resultpdfobr)
        {
                rowString5 = `
                <table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`46" name="ISCV_IBE_Parsing`+$TableCtr+`46" value="`+resultpdfobr.obr_4_2_iscv_val+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`46" name="Expected_HL7_Parsing`+$TableCtr+`46"  value="`+resultpdfobr.obr_4_2_hl7_parsing+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
              ...
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`51" name="Comments`+$TableCtr+`51" value="`+resultpdfobr.obr_8_comments+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
              ...
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`55" name="Comments`+$TableCtr+`55" value="`+resultpdfobr.obr_22_comments+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`55" name="ISCV_IBE_Parsing`+$TableCtr+`55"  value="`+resultpdfobr.obr_31_iscv_val+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
              ...
              <div class="ui form">
                ...
                $('#results_utrTable tbody:last').before(rowString5);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_obx,function(key,resultpdfobx)
        {
                rowString6 = `
                <table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`66" name="ISCV_IBE_Parsing`+$TableCtr+`66" value="`+resultpdfobx.obx_4_iscv_val+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`68" name="ISCV_IBE_Parsing`+$TableCtr+`68"  value="`+resultpdfobx.obx_11_iscv_val+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`68" name="Expected_HL7_Parsing`+$TableCtr+`68" value="`+resultpdfobx.obx_11_hl7_parsing+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_Value`+$TableCtr+`68" name="Expected_Value`+$TableCtr+`68" value="`+resultpdfobx.obx_11_expected_val+`" />
                </div>
              </td>
              <td colspan="2">
                <div class="ui form">
                  <input type="text" id="Actual_Value`+$TableCtr+`68" name="Actual_Value`+$TableCtr+`68" value="`+resultpdfobx.obx_11_actual_val+`" />
                </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Pass_fail`+$TableCtr+`71" name="Pass_fail`+$TableCtr+`71" value="`+resultpdfobx.obx_11_pass+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`71" name="Comments`+$TableCtr+`71" value="`+resultpdfobx.obx_11_comments+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`71" name="Sign_off`+$TableCtr+`71" value="`+resultpdfobx.obx_11_signoff+`" />
              </div>
              </td>
              </tr>
              </tbody>
                ...
                $('#results_utrTable tbody:last').before(rowString6);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 
...
{
        //Sample Messages Table
        $.each(response.testplan_resultutr_zds,function(key,resultpdfzds)
        {
                rowString7 = `
                <table class="ui celled table black unstackable" ">
                <tbody>
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`69" name="Expected_HL7_Parsing`+$TableCtr+`69" value="`+resultpdfzds.zds_1_hl7_parsing+`" />
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_Value`+$TableCtr+`69" name="Expected_Value`+$TableCtr+`69" value="`+resultpdfzds.zds_1_expected_val+`" />
                </div>
              </td>
              <td colspan="2">
                <div class="ui form">
                  <input type="text" id="Actual_Value`+$TableCtr+`69" name="Actual_Value`+$TableCtr+`69" value="`+resultpdfzds.zds_1_actual_val+`" />
                </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Pass_fail`+$TableCtr+`72" name="Pass_fail`+$TableCtr+`72" value="`+resultpdfzds.zds_1_pass+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`72" name="Comments`+$TableCtr+`72" value="`+resultpdfzds.zds_1_comments+`" />
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`72" name="Sign_off`+$TableCtr+`72" value="`+resultpdfzds.zds_1_signoff+`" />
              </div>
              </td>
              </tr>
                ...
                $('#results_utrTable tbody:last').before(rowString7);
                $('.deleteRow').attr("disabled", true);
                $('#TableCtr').val($TableCtr);
                $TableCtr++ ;
        }); 

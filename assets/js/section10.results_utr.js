...
var url = apiUrl+'/section10/result_utr/fetch_oru.php?prs=' + prs + '&token=' + token;
...
var url1 = apiUrl+'/section10/result_utr/fetch_msh.php?prs=' + prs + '&token=' + token;
...
var url2 = apiUrl+'/section10/result_utr/fetch_pid.php?prs=' + prs + '&token=' + token;
...
var url3 = apiUrl+'/section10/result_utr/fetch_pv1.php.php?prs=' + prs + '&token=' + token;
$.getJSON(url,function(response)
{
        //Sample Messages Table
...
var url4 = apiUrl+'/section10/result_utr/fetch_orc.php?prs=' + prs + '&token=' + token;
...
var url5 = apiUrl+'/section10/result_utr/fetch_obr.php?prs=' + prs + '&token=' + token;
...
var url6 = apiUrl+'/section10/result_utr/fetch_obx.php?prs=' + prs + '&token=' + token;
$.getJSON(url6,function(response)
{
        ...
        $.each(response.testplan_resulttext_obx,function(key,resultpdfobx)
        {
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`66" name="ISCV_IBE_Parsing`+$TableCtr+`66" value="`+resultpdfpid.obx_5_iscv_val+`"/>
                </div>
              </td>
              <td>
                <div class="ui form">
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="ISCV_IBE_Parsing`+$TableCtr+`68" name="ISCV_IBE_Parsing`+$TableCtr+`67" placeholder="P | F | C | R | D" value="`+resultpdfpid.obx_11_iscv_val+`"/>
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`70" name="Expected_HL7_Parsing`+$TableCtr+`70" value="`+resultpdfpid.obx_11_hl7_parsing+`"/>
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_Value`+$TableCtr+`70" name="Expected_Value`+$TableCtr+`70" value="`+resultpdfpid.obx_11_expected_val+`"/>
                </div>
              </td>
              <td colspan="2">
                <div class="ui form">
                  <input type="text" id="Actual_Value`+$TableCtr+`70" name="Actual_Value`+$TableCtr+`70" value="`+resultpdfpid.obx_11_actual_val+`"/>
                </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Pass_fail`+$TableCtr+`73" name="Pass_fail`+$TableCtr+`73" value="`+resultpdfpid.obx_11_pass+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`73" name="Comments`+$TableCtr+`73" value="`+resultpdfpid.obx_11_comments+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`73" name="Sign_off`+$TableCtr+`73" value="`+resultpdfpid.obx_11_signoff+`"/>
              </div>
              </td>
              </tr>
              </tbody>
...
var url7 = apiUrl+'/section10/result_utr/fetch_zds.php?prs=' + prs + '&token=' + token;
$.getJSON(url7,function(response)
{
        ...
        $.each(response.testplan_resulttext_zds,function(key,resultpdfzds)
        {
              ...
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_HL7_Parsing`+$TableCtr+`71" name="Expected_HL7_Parsing`+$TableCtr+`71" value="`+resultpdfpid.zds_1_hl7_parsing+`"/>
                </div>
              </td>
              <td>
                <div class="ui form">
                  <input type="text" id="Expected_Value`+$TableCtr+`71" name="Expected_Value`+$TableCtr+`71" value="`+resultpdfpid.zds_1_expected_val+`"/>
                </div>
              </td>
              <td colspan="2">
                <div class="ui form">
                  <input type="text" id="Actual_Value`+$TableCtr+`71" name="Actual_Value`+$TableCtr+`71" value="`+resultpdfpid.zds_1_actual_val+`"/>
                </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Pass_fail`+$TableCtr+`74" name="Pass_fail`+$TableCtr+`74" value="`+resultpdfpid.zds_1_pass+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Comments`+$TableCtr+`74" name="Comments`+$TableCtr+`74" value="`+resultpdfpid.zds_1_comments+`"/>
              </div>
              </td>
              <td>
              <div class="ui form">
                <input type="text" id="Sign_off`+$TableCtr+`74" name="Sign_off`+$TableCtr+`74" value="`+resultpdfpid.zds_1_signoff+`"/>
              </div>
              </td>
              </tr>

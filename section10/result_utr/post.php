<?php
	...
	if($_POST['token'])
	{
		...
		$sql1 = "DELETE FROM section10_testplan_resultsutr_msh
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql1);

		$sql2 = "DELETE FROM section10_testplan_resultsutr_obr
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql2);

		$sql3 = "DELETE FROM section10_testplan_resultsutr_obx
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql3);

		$sql4 = "DELETE FROM section10_testplan_resultsutr_orc
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql4);

		$sql5 = "DELETE FROM section10_testplan_resultsutr_pid
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql5);

		$sql6 = "DELETE FROM section10_testplan_resultsutr_pv1
				WHERE sec_sign='$token'" ;

				mysqli_query($dcConn,$sql6);

		$sql7 = "DELETE FROM section10_testplan_resultsutr_zds
				WHERE sec_sign='$token'" ;
...
$sql18 = "INSERT INTO section10_testplan_resultsutr (sec_sign,
oru_date, 
	    		...
	    		$sql1 = "INSERT INTO section10_testplan_resultsutr_msh (sec_sign,msh_1_iscv_val,
msh_1_hl7_parsing,
msh_1_expected_val,
msh_1_actual_val,
msh_1_pass,
...
$sql12 = "INSERT INTO section10_testplan_resultsutr_pid(sec_sign,pid_3_iscv_val,
pid_3_hl7_parsing,
pid_3_expected_val,
pid_3_actual_val,
pid_3_pass,
...
'$pid_18_iscv_val','$pid_18_hl7_parsing','$pid_18_expected_val','$pid_18_actual_val','$pid_18_pass','$pid_18_comments','$pid_18_signoff')";
	    		...
	    		$sql13 = "INSERT INTO section10_testplan_resultsutr_pv1(sec_sign,pv1_2_iscv_val,
pv1_2_hl7_parsing,
pv1_2_expected_val,
pv1_2_actual_val,
pv1_2_pass,
...
'$pv1_8_2_signoff')";
	    		...
	    		$sql4 = "INSERT INTO section10_testplan_resultsutr_orc(sec_sign,orc_1_iscv_val,
orc_1_hl7_parsing,
orc_1_expected_val,
orc_1_actual_val,
orc_1_pass,
...
'$orc_5_iscv_val','$orc_5_hl7_parsing','$orc_5_expected_val','$orc_5_actual_val','$orc_5_pass','orc_5_comments','$orc_5_signoff')";
	    		...
	    		$sql15 = "INSERT INTO section10_testplan_resultsutr_obr(sec_sign,obr_1_iscv_val,
obr_1_hl7_parsing,
obr_1_expected_val,
obr_1_actual_val,
obr_1_pass,
...
'$obr_32_1_4_iscv_val','$obr_32_1_4_hl7_parsing','$obr_32_1_4_expected_val','$obr_32_1_4_actual_val','$obr_32_1_4_pass','obr_32_1_4_comments','$obr_32_1_4_signoff')";
	    		...
	    		$sql6 = "INSERT INTO section10_testplan_resultsutr_obx(sec_sign,obx_1_iscv_val,
obx_1_hl7_parsing,
obx_1_expected_val,
obx_1_actual_val,
obx_1_pass,
...
'$obx_11_iscv_val','$obx_11_hl7_parsing','$obx_11_expected_val','$obx_11_actual_val','$obx_11_pass','$obx_11_comments','$obx_11_signoff')";
	    		...
	    		$sql7 = "INSERT INTO section10_testplan_resultsutr_zds(sec_sign,zds_1_iscv_val,
zds_1_hl7_parsing,
zds_1_expected_val,
zds_1_actual_val,
zds_1_pass,
...
zds_1_signoff) VALUES ('$token','$zds_1_iscv_val','$zds_1_hl7_parsing',
	    ...
	    //Update Sections
	    $sql = "UPDATE sections
	    		SET section10_resultsutr='$token',section10_resultsutr_msh='$token',section10_resultsutr_obr='$token',section10_resultsutr_obx='$token',section10_resultsutr_orc='$token',section10_resultsutr_pid='$token',section10_resultsutr_pv1='$token',section10_resultsutr_zds='$token'
